...
buttons.forEach(button => {
    ...
    button.addEventListener('click',() =>{
        ...
        if (nom == "Réaliser")
        {
            ...
            divText.innerHTML += '<p><a class="lien" href="./Competences/realiser1.html">AC11.02 | Élaborer des conceptions simples</a></p>'
            divText.innerHTML += '<p><a class="lien" href="./Competences/realiser1.html">AC11.03 | Faire des essais et évaluer leurs résultats en regard des spécifications</a></p>'
